...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white border border-bottom-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="../index.html"><span class="title normal_text_color">Cusit Fiverr</sapn><sub style="font-size:11px;font-family: Arial, Helvetica, sans-serif;">buyer Security</sub></a>
...
<div class="container">
    <div class="row">
        ...
        <div class="card p-4" style="width:30rem;border-radius:3px;">
            ...
            <hr><br>
            <form action="../BackendLogic/buyerlogic/security.php" method="post">
