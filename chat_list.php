...
<head>
    ...
    function initializeSocket(){
       socket = io.connect("http://127.0.0.1:3000/", { query: "userId="+userId});
    ...
    $("#send_message_ch_div").on("click",function () {
        ...
        success:function (response) {
                ...
                console.log(userId+"_________");
                getDistinctMsgShow(jsonParsed['emailRedirect']);
                initializeSocket();
                onLeaveMessage();
            }
    })
...
<body>
    ...
    <div id="chat_div_ch_div" style="z-index:10 margin:-10px">
        ...
        <div id="text_input_ch_div" style="width:98%;margin-left:-15px;padding:20px;background-color:rgb(44, 31, 117);margin-top:0px;">
            <input id="input_self_ch_div" style="width:60%;border-radius:20px;padding:10px;border:0" />
